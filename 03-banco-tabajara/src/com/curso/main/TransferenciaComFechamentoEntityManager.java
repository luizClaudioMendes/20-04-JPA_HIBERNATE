...
import com.curso.modelo.Conta;

public class TransferenciaComFechamentoEntityManager {
	...
	public static void main(String[] args) {
		...
		em.close(); //fechamento do entity manager
		
		//ja que o entitymanager esta fechado, crio um novo entity manager
		em = emf.createEntityManager();
		
		//como este novo entitymanager é um novo objeto, ele
		//na gerencia mais os objetos conta, logo é imprescindivel
		//que se utilize o metodo merge() ou persist()
		...
		em.merge(conta1);//colocando novamente os objetos no gerenciamento do em
		em.merge(conta2);
